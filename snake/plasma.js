var Plasma = function (type, x ,y) {
  ...
  var state = this;
  $('#game-container').append(state.el)
  var startx = $('#game-context').position().left; 
  var starty = $('#game-context').position().top;
  if(x && y) this.setPosition(startx + Game.env.width - 100, starty + Game.env.height - 80);
  this.t = 0;
}
